...
class Player(BasePlayer):
    ...
    comprehension1 = models.PositiveIntegerField(label='If you contributed 30 points in the public good, how much of your income do you still have left (before the payment of the bonus)?')
    ...
    def comprehension2_error_message (self, value):
        ...
        if value != 30:
            return "Wrong answer to question 2. Please read the instructions again. You can download them at the bottom of the page. Remember that if the threshold is not reached - no bonus is paid and the contributions are not refunded."
